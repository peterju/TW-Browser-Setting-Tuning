:: Microsoft Edge 彈出式視窗與私有網路存取政策修復腳本
@echo off
...
echo 正在修正 Microsoft Edge 政策設定...

:: ================= 設定區塊 =================
:: 設定要加入白名單的網址 (建議使用 [*.] 格式)
set "browser_name=Microsoft Edge"
set "process_name=msedge.exe"
set "reg_root=Software\Policies\Microsoft\Edge"
...
echo.
echo 設定完成！
echo 請重新開啟 %browser_name%，並在網址列檢查 edge://policy。
timeout 8